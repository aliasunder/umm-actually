...
| `conventions_file`        | `AGENTS.md`                   | Repo-relative path to the conventions file included in the prompt (truncated at ~8000 tokens). When it also changed in the PR, the changed-files copy is included diff-only so its text is not sent twice                                                                                                                                            |
